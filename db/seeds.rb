...
n3 = Notification.create(user_id: u1.id, reason: 'Billy liked your Post!', post_id: p1.id, friend_id: u2.id)
n4 = Notification.create(user_id: u1.id, reason: 'Billy liked your Post!', post_id: p1.id, friend_id: u2.id)
n5 = Notification.create(user_id: u1.id, reason: 'Billy liked your Post!', post_id: p1.id, friend_id: u2.id)
n6 = Notification.create(user_id: u1.id, reason: 'Billy liked your Post!', post_id: p1.id, friend_id: u2.id)